...
void GatePulseProcessorChainMessenger::DoInsertion(const G4String& childTypeName)
{
  ...
  else if (childTypeName=="sipm")
      newProcessor = new GateSiPM(GetProcessorChain(),newInsertionName);
#ifdef GATE_USE_OPTICAL
